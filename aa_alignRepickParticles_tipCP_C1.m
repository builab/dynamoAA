...
boxSize = 60;
pixelSize = 14.00;
refID = 1; % 1 for C1, 2 for C2
filamentRepickListFile = 'filamentRepickCPListC1.csv';
particleDir = sprintf('%sparticles_repick', prjPath);
mw = 8; % Number of parallel workers to run
gpu = [0 1]; % Alignment using gpu, for lots of particles, use more than 1
template_name = 'templates/tipC1_14.00Apx_new.em';
tableFileName = 'merged_particles_tipC1_repick.tbl'; % merged particles table all
starFileName = 'merged_particles_tipC1_repick.star'; % star file name for merged particles
tableOutFileName = 'merged_particles_tipC1_repick_align.tbl'; % merged particles table all
pAlnAll = 'pAlnRepickParticles_C1';
refMask = 'mask_cylinder.em'; % Better be tipC1/tip specific mask
...
newRefFile = 'average_allRepickParticles_tipC1.em';

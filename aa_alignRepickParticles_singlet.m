...
template_name = 'average_RepickAvg_manualaln.em';
tableFileName = 'merged_particles_singlet_repick.tbl'; % merged particles table all
starFileName = 'merged_particles_singlet_repick.star'; % star file name for merged particles
tableOutFileName = 'merged_particles_singlet_repick_align.tbl'; % merged particles table all
pAlnAll = 'pAlnRepickParticles_singlet';
refMask = 'mask_cylinder.em'; % Better be singlet/tip specific mask
...
newRefFile = 'average_allRepickParticles_singlet.em';

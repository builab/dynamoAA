...
pixelSize = 14.00; % Use to calculate lowpass
boxSize = 60; % Extracted subvolume size
mw = 12; % Number of parallel workers to run
lowpass = 40; % In Angstrom Filter the initial average to 60
minPartNo = 2; % Minimum particles number per Filament 4 is reasonable

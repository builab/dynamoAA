...
pixelSize = 14.00;
boxSize = 64;
filamentListFile = 'manualFilamentListPolarity.csv';
alnDir = sprintf('%sintraAln', prjPath);
particleDir = sprintf('%sparticles', prjPath);
mw = 12; % Number of parallel workers to run
gpu = [0]; % Alignment using gpu
template_name = 'average_intraAln.em'; % If you have a better reference, use it instead
tableFileName = 'merged_particles_doublet_8nm.tbl'; % merged particles table all
tableOutFileName = 'merged_particles_doublet_8nm_align.tbl'; % merged particles table all
starFileName = 'merged_particles_doublet_8nm.star'; % star file name for merged particles
...
zshift_limit = 4; % 8nm shift limit
outputFile = 'average_allParticles.em';

...
boxSize = 60;
mw = 12;
subunits_dphi = 0.66;  % For the tip CP 0.72, baseCP 0.5, doublet 0
...
filamentListFile = sprintf('%smanualFilamentCPList.csv', prjPath);
tableAlnFileName = 'merged_particles_tipCP_align.tbl'; % merge particles before particle alignment for robust but must be merged_particles_align to use doInitialAngle
